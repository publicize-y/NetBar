            ...
            <c:forEach items="${list}" var="user" varStatus="stat">
                <tr>
                    ...
                    <td class="td-manage">
                        ...
                        <a title="修改密码"  href='${pageContext.request.contextPath}/admin/toupdate?id=${user.id}'>
...
<script type="text/javascript">
    ...
    function member_del(obj,id){
        layer.confirm('确认要删除吗？',function(index){
            //发异步删除数据
            //等以后再使用异步，这里先使用
            $.get("${pageContext.request.contextPath}/admin/delete?id="+id);
           // $.ajax("${pageContext.request.contextPath}/admin/delete)?id="+id)
