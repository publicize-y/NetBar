...
<body class="layui-layout-body">
        <!-- 内容主体区域 -->
        <span class="layui-breadcrumb"> <a href="${pageContext.request.contextPath}/admin/towelcome">首页</a> <a> <cite>会员卡充值</cite></a></span>
        ...
        form.on('submit(add)', function(data){
            ...
            var idnumber=document.getElementById("idnumber");
                layer.confirm("你确定要充值吗？", function() {
                    $.post({
                        url:"${pageContext.request.contextPath}/ajax/updatemoney1",
                        data:{
                            "money":$("#money").val(),
